...
contract QualityCoin is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'QualityCoin';
    string  private constant _SYMBOL = 'QUALITY';
    ...
    uint256 private    _BURN_FEE = 5; // 0.05% BURNED
    uint256 private _CHARITY_FEE = 45; // 0.45% TO CHARITY WALLET
